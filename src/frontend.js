function display_description()
{
   ...
   for(let i = 0; i < list_of_items.length; i++)
   {
       ...
       more_description.addEventListener("click",() => {show_full_description("more", full_description, description) })
       less_description.addEventListener("click", ()=>{show_full_description("less", full_description, description)})
   }
